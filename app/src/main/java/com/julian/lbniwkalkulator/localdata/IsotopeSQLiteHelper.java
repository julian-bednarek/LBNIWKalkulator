...
public class IsotopeSQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String  SQL_CREATE_ENTRIES =
            "CREATE TABLE " + IsotopeEntry.TABLE_NAME + " (" +
            IsotopeEntry._ID                                + " INTEGER PRIMARY KEY," +
            IsotopeEntry.COLUMN_NAME_ISOTOPE_NAME           + " TEXT," +
            IsotopeEntry.COLUMN_NAME_ACTIVITY               + " REAL," +
            IsotopeEntry.COLUMN_NAME_MOST_RECENT_TIMESTAMP  + " INTEGER," +
            IsotopeEntry.COLUMN_NAME_HALF_LIFE_TIME         + " REAL)";
